 ...
 * The collection name can be changed by setting {@see \rock\mongodb\Session::$essionCollection}.
 *
...
class Session extends \rock\session\Session
{
    ...
    public function writeSession($id, $data)
    {
        ...
        try {
            $this->connection->getCollection($this->sessionCollection)->update(
                ['id' => $id],
                [
                    'id' => $id,
                    'data' => $data,
    ...
    {
        $this->connection->getCollection($this->sessionCollection)->remove(
            ['id' => $id],
            ['justOne' => true]
        );
