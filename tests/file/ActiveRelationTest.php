...
namespace rockunit\file;

use rockunit\models\Customer;
use rockunit\models\file\CustomerFile;
use rockunit\MongoDbTestCase;
...
class ActiveRelationTest extends MongoDbTestCase
{
    ...
    {
        parent::setUp();
        \rockunit\models\ActiveRecord::$connection = $this->getConnection();
        \rockunit\models\file\ActiveRecord::$connection = $this->getConnection();
        $this->setUpTestRows();
    }
